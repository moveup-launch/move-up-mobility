    ...
    <div id="landing">
      ...
      <header className="landing-header">
        <div className="landing-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ fontFamily: 'var(--font-display)', fontSize: 20, color: '#1A1917', letterSpacing: -0.4 }}>Move Up App</span>
          </div>
      ...
      <section className="landing-section" style={{ textAlign: 'center' }}>
        <div className="landing-container">
          ...
          <p className="landing-section-sub">Rejoignez les professionnels qui font confiance à Move Up App</p>
        ...
        <div className="landing-container">
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12, marginBottom: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <span style={{ fontFamily: 'var(--font-display)', fontSize: 16, color: 'white' }}>Move Up App</span>
            </div>
            <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: 13 }}>
              moveupapp.com · © 2026 Move Up
            </div>
